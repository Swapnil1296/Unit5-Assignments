...
function App() {
  ...
  return (
    <div className="App">
      <div className="nav">
        <div className="logo"><img className='image' src="https://img.freepik.com/free-vector/bakery-badges-vintage-style_23-2147509937.jpg?size=338&ext=jpg&ga=GA1.2.2097566864.1649502891" alt="" /></div>
        <div className="links">
          {mid.map((e) => {
